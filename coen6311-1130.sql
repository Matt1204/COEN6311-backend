...
-- ----------------------------
INSERT INTO `preference_template` VALUES (1, 13, 'morning', 20, '[\"Monday\", \"Tuesday\"]', 8, '[2, 1, 3]', '44-tempplate1');
INSERT INTO `preference_template` VALUES (2, 13, 'night', 44, '[\"Monday\", \"Friday\", \"Sunday\"]', 8, '[1, 3, 2]', '44-tempplateb');
...
-- ----------------------------
-- Table structure for request_template
-- ----------------------------
DROP TABLE IF EXISTS `request_template`;
CREATE TABLE `request_template`  (
  `template_id` int NOT NULL AUTO_INCREMENT,
  `hospital_id` int NOT NULL COMMENT 'foreign key',
  `supervisor_id` int NOT NULL COMMENT 'foreign key to user (role = \"supervisor\")',
  ...
  `day_of_week` enum('Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '\'Monday\',\'Tuesday\',\'Wednesday\',\'Thursday\',\'Friday\',\'Saturday\',\'Sunday\'',
  `nurse_number` int NOT NULL DEFAULT 6 COMMENT 'default 6',
  `min_seniority` int NOT NULL COMMENT 'min_seniority from 1 to 10',
  PRIMARY KEY (`template_id`) USING BTREE,
  INDEX `hospital_id`(`hospital_id` ASC) USING BTREE,
  INDEX `supervisor_id`(`supervisor_id` ASC) USING BTREE,
  CONSTRAINT `request_template_ibfk_1` FOREIGN KEY (`hospital_id`) REFERENCES `hospital` (`h_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `request_template_ibfk_2` FOREIGN KEY (`supervisor_id`) REFERENCES `user` (`u_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `request_template_chk_1` CHECK (`min_seniority` between 1 and 10)
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of request_template
-- ----------------------------
...
INSERT INTO `shift_preference` VALUES (64, 13, 'afternoon', '2024-12-09', '2024-12-15', 80, '[\"Monday\", \"Sunday\", \"Thursday\"]', 12, '[3, 2, 1]');
